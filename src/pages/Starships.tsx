        ...
        <table className='w-full min-w-[500px] text-left text-gray-100 text-sm sm:text-base rounded-xl'>
          ...
          <tbody>
            {visibleStarships.map((ship) => (
              ...
              >
                <td className='px-6 py-4 font-medium text-indigo-100'>{ship.name}</td>
                <td className='px-6 py-4 text-indigo-100'>{ship.model}</td>
                <td className='px-6 py-4 text-indigo-100'>{ship.manufacturer}</td>
                <td className='px-6 py-4 text-indigo-100'>{ship.starship_class}</td>
              </tr>
            ))}
          </tbody>
        </table>
